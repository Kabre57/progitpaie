...
/**
 * Formate proprement un nombre avec des espaces ASCII (évite l'espace insécable Unicode U+202F qui s'affiche sous forme de '/' dans jsPDF Helvetica font)
 */
...
export async function GET(
  ...
  try {
    ...
    // Informations Salarié (Déchiffrement transparent des données RGPD)
    ...
    // Déchiffrement du N° CNPS pour impression en clair
    ...
    // 1. TOP HEADER (PROGI PAIE Format)
    doc.setFontSize(14);
