...
- **Statut distant : ROTATION SANS ÉCRITURE / VALIDATION EN ATTENTE.** Le déploiement, les migrations et les contrôles à blanc sont confirmés ; l'opérateur doit effectuer le contrôle de santé et consigner l'exécution finale sans déclarer de ré-encryption effective.
