...
- **Statut distant : ROTATION SANS ÉCRITURE / EXÉCUTION FINALE EN ATTENTE.** Le déploiement, les migrations, les contrôles à blanc et la validation métier sont confirmés ; l'exécution réelle sera un contrôle sans écriture attendue, suivi du health check.
