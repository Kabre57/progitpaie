...
const navItems = [
  { name: "Mon Tableau de Bord", href: "/employee", icon: LayoutDashboard },
  { name: "Mes Pointages", href: "/employee/attendance", icon: ClipboardCheck },
  { name: "Demande de Congé", href: "/employee/leaves", icon: CalendarPlus },
  { name: "Mon Bulletin de Paie", href: "/employee/payslip", icon: FileText },
  { name: "Mes Notifications", href: "/employee/notifications", icon: Bell },
];
