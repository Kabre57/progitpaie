  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative p-2 rounded-lg hover:bg-[var(--neu-surface-light)] transition-colors"
      >
          ...
          <div className="absolute right-0 top-full mt-2 w-80 bg-[var(--neu-surface)] rounded-xl shadow-lg border border-[var(--neu-border)] z-50 max-h-96 overflow-hidden">
            ...
            <div className="overflow-y-auto max-h-72">
              {notifications.length === 0 ? (
                <div className="p-4 text-center text-sm text-[var(--neu-text-secondary)]">
                  Aucune notification
                </div>
              ) : (
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-bold text-sm text-[var(--neu-text)] truncate">
                          {notification.title}
                        </p>
                        <p className="text-xs text-[var(--neu-text-secondary)] line-clamp-2 mt-0.5">
                          {notification.message}
                        </p>
                        <p className="text-[10px] text-[var(--neu-text-muted)] mt-1 font-medium">
