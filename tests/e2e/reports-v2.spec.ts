...
test.describe("Qualification E2E — Module Reports V2", () => {
  test("1. Endpoint V2 : Consultation des analytics RH", async ({ request }) => {
    const v2Res = await request.get(`${baseUrl}/api/v2/reports/analytics`);
